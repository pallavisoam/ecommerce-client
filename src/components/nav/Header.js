...
import {  AppstoreOutlined,LogoutOutlined,ShoppingCartOutlined ,SettingOutlined , UserOutlined , UserAddOutlined,ShoppingOutlined} from '@ant-design/icons';
...
<span className = "float-right p-1"><Search />
</span>  
